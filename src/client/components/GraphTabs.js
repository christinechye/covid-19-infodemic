...
const GraphTabs = (props) => {
    const { state } = props; 
    const Arizona = [ require('../../images/AZ/AZ_cov_news1.png'), require('../../images/AZ/AZ_cov_news2.png'), require('../../images/AZ/AZ_cov_stop_4.png'), require('../../images/AZ/AZ_inst_trust1_2.png'), require('../../images/AZ/AZ_inst_trust1_5.png')];
      ...
      <React.Fragment>
          ...
          <Tabs defaultActiveKey="survey">
              ...
              <Tab eventKey="survey" title="Survey">
                  <center><h4>In the last 24 hours, did you get any news or information related to the current coronavirus (COVID-19) outbreak from the following sources?</h4><img style={graphStyle} src={logo}/></center>
              </Tab>
